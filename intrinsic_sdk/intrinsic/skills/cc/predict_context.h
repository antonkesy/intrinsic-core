...
#ifndef INTRINSIC_SKILLS_CC_PREDICT_CONTEXT_H_
#define INTRINSIC_SKILLS_CC_PREDICT_CONTEXT_H_
...
// Provides extra metadata and functionality for a Skill::Predict call.
//
...
class PredictContext {
 public:
  ...
  // The GeometryLibrary associated with this context.
  virtual GeometryLibrary& geometry_library() const = 0;
...
#endif  // INTRINSIC_SKILLS_CC_PREDICT_CONTEXT_H_
