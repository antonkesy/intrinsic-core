...
class SensorComponent {
 public:
  ...
  // Get low-level device name.
  virtual const std::string& GetDeviceName() const = 0;

  // Set low-level device name.
  virtual void SetDeviceName(absl::string_view name) = 0;

  // Get low-level device type.
  virtual const std::string& GetDeviceType() const = 0;

  // Set low-level device type.
  virtual void SetDeviceType(absl::string_view type) = 0;
