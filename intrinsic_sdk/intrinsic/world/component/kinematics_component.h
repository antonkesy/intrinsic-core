...
class KinematicsComponent {
 public:
  ...
  // TODO(b/361105294): Remove Get/SetOutboardTChild when we don't need the
  // convention for child link of a joint to have identity transform
  // Gets the joint's outboard_t_child transform.
  ABSL_DEPRECATED(
  ...
  // intrinsic/world/public/proto/kinematics_component.proto?q=%22enum+MotionType%22.
  ...
  // Returns the DoF's label.
  virtual DofLabel GetDofLabel() const = 0;
