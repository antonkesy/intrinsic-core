...
class GeometryComponent {
 public:
  ...
  // TODO(b/447006911): Deprecate this function and replace with a function that
  // takes NamedGeometrySet instead so names can be specified instead of
  // generated from the vector index.
