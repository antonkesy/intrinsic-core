...
GeometryComponentFromSdfLink(const ::sdf::Link& sdf_link,
  ...
  // TODO(b/447282419): We need to set the visual geo key even if it's empty.
  ...
  // TODO(b/447282419): We need to set the collision geo key even if it's empty.
...
absl::StatusOr<std::optional<TransformedGeometry>> GeometryFromSdfCollision(
  ...
  // TODO(b/322555547): Handle <surface> when Geo Asset supports.
