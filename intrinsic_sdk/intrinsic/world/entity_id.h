...
struct TypedEntityId : public AggregateType<EntityBase, ComponentTypes...> {
  ...
  // TODO(stoyang): Restrict creation of these types to the World.
  // This restriction will enable us to do runtime validation before
  // construction and limit the number of places that a TypedEntityId can be
  // constructed. We can however unrestrict TypedEntityId<>.
