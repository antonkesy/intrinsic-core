...
ThreadOptions& ThreadOptions::SetRealtimeGuarded() {
  is_realtime_guarded_ = true;
  return *this;
}

ThreadOptions& ThreadOptions::SetMallocGuarded(bool enable) {
  is_malloc_guarded_ = enable;
  return *this;
}

ThreadOptions& ThreadOptions::SetSkipInitializingThreadLocalTracer() {
  initialize_thread_local_tracer_ = false;
  return *this;
}
