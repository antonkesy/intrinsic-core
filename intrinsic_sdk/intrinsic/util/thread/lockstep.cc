...
// TODO(gaschler): Consider deleting this and implement in-place construction
// in SharedMemoryManager using allocator_traits::construct, similar to
// https://github.com/intrinsic-ai/intrinsic-core/blob/main/google3/util/gtl/flat_internal.h#L167
