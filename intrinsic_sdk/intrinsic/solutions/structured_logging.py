...
class StructuredLogs:
  ...
  def get_event_source(self, event_source: str) -> EventSourceReader:
    ...
    #
    # TODO(b/379032395): Remove use of the cache if we implement server-side
    # caching or locking to make ListLogSources more efficient.
    cached_matches = [
        s
  ...
  # TODO: b/284953026 - Add proper type annotation for 'solution' once
  # deployments.py does not depend on structured_logging.py anymore via
  # pose_estimation.py. Currently this would introduce a cyclic dependency.
  @classmethod
