...
class BlackboardValue:
  ...
  def __getattribute__(self, name: str) -> Any:
    ...
    # TODO(b/225170958) This is a workaround for Duration/Timestamp being
    # treated differently by CEL and can be removed once the bug gets resolved.
  ...
  def value_access_path(self) -> str:
    ...
    A more in-depth description of the blackboard can be found in the TDD:
