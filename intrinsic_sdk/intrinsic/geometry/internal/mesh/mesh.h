...
// TODO(b/417296237): Attempt to use only v1 protos
...
REGISTER_RIEGELI_PROTO_CODER_EXPLICIT(intrinsic::geo::Mesh,
                                      intrinsic_proto::geometry::TriangleMesh,
                                      intrinsic::geo::ToTriangleMeshProto,
                                      intrinsic::geo::FromProto)
