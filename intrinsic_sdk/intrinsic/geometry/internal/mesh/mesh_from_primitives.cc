...
#include "intrinsic/geometry/internal/mesh/mesh_primitives.h"
...
absl::StatusOr<Mesh> MeshFromPrimitive(const ShapeBase& shape) {
  switch (shape.getType()) {
    case ShapeType::CYLINDER: {
      // TODO(jeanfrancoisd): Maybe create a cylinder with igl/include/cylinder
    ...
    case ShapeType::FRUSTUM: {
      const auto& frustum = shape.get<Frustum>();
