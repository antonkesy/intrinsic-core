...
namespace intrinsic {
using ::intrinsic::geo::MakeCapsule;
using ::intrinsic::geo::MakeCenteredBox;
using ::intrinsic::geo::MakeCylinder;
using ::intrinsic::geo::MakeSphere;
using ::intrinsic::geo::MakeTransformedCapsule;
using ::intrinsic::geo::MakeTransformedCenteredBox;
using ::intrinsic::geo::MakeTransformedCylinder;
using ::intrinsic::geo::MakeTransformedSphere;
}  // namespace intrinsic
