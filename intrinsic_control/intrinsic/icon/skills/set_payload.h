...
#ifndef INTRINSIC_ICON_SKILLS_SET_PAYLOAD_H_
#define INTRINSIC_ICON_SKILLS_SET_PAYLOAD_H_
...
class SetPayload final : public SkillInterface {
 public:
...
#endif  // INTRINSIC_ICON_SKILLS_SET_PAYLOAD_H_
