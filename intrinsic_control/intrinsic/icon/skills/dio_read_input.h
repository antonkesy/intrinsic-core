...
#ifndef INTRINSIC_ICON_SKILLS_DIO_READ_INPUT_H_
#define INTRINSIC_ICON_SKILLS_DIO_READ_INPUT_H_
...
class DioReadInput final : public SkillInterface {
 public:
  ...
  // Preview always returns an empty result without checking the skill
  // parameters.
...
#endif  // INTRINSIC_ICON_SKILLS_DIO_READ_INPUT_H_
