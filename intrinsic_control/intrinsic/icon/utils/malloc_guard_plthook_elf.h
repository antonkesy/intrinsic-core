...
#ifndef INTRINSIC_ICON_UTILS_MALLOC_GUARD_PLTHOOK_ELF_H_
#define INTRINSIC_ICON_UTILS_MALLOC_GUARD_PLTHOOK_ELF_H_
...
#endif  // INTRINSIC_ICON_UTILS_MALLOC_GUARD_PLTHOOK_ELF_H_
