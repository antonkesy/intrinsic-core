...
#ifndef INTRINSIC_ICON_PROTO_JOINT_STATE_CONVERSION_H_
#define INTRINSIC_ICON_PROTO_JOINT_STATE_CONVERSION_H_
...
#endif  // INTRINSIC_ICON_PROTO_JOINT_STATE_CONVERSION_H_
