...
StreamingJointPositionInfo::FixedParams GetStreamingJointPositionFixedParams(
  ...
  StreamingJointPositionInfo::FixedParams fixed_params;
...
StreamingJointPositionInfo::FixedParams GetStreamingJointPositionFixedParams(
  ...
  StreamingJointPositionInfo::FixedParams params =
      GetStreamingJointPositionFixedParams(goal_position, goal_velocity);
  *params.mutable_joint_limits() = ToProto(joint_limits);
  return params;
}
