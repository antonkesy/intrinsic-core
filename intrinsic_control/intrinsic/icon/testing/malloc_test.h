...
#ifndef INTRINSIC_ICON_TESTING_MALLOC_TEST_H_
#define INTRINSIC_ICON_TESTING_MALLOC_TEST_H_
...
#define IF_INTRINSIC_MALLOC_TEST_INIT_COUNTER()                         \
  INTRINSIC_RT_LOG_THROTTLED(WARNING)                                   \
      << "Ignoring IF_INTRINSIC_MALLOC_TEST_INIT_COUNTER on non-linux " \
         "platform.";
#endif
...
#endif  // INTRINSIC_ICON_TESTING_MALLOC_TEST_H_
