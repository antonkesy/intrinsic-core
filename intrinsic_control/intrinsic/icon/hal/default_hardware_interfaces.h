...
#include "intrinsic/icon/hal/interfaces/encoder.fbs.h"
#include "intrinsic/icon/hal/interfaces/encoder_utils.h"
#include "intrinsic/icon/hal/interfaces/imu.fbs.h"
#include "intrinsic/icon/hal/interfaces/imu_utils.h"
#include "intrinsic/icon/hal/interfaces/internal_command.fbs.h"
#include "intrinsic/icon/hal/interfaces/internal_command_utils.h"
...
#include "intrinsic/icon/hal/interfaces/rangefinder_utils.h"
...
INTRINSIC_ADD_HARDWARE_INTERFACE(intrinsic_fbs::EncoderStatus,
                                 intrinsic_fbs::BuildEncoderStatus,
                                 "intrinsic_fbs.EncoderStatus")

INTRINSIC_ADD_HARDWARE_INTERFACE(intrinsic_fbs::InternalCommandStatus,
                                 intrinsic_fbs::BuildInternalCommandStatus,
                                 "intrinsic_fbs.InternalCommandStatus")

INTRINSIC_ADD_HARDWARE_INTERFACE(intrinsic_fbs::RangeFinderStatus,
                                 intrinsic_fbs::BuildRangefinderStatus,
                                 "intrinsic_fbs.RangeFinderStatus")

INTRINSIC_ADD_HARDWARE_INTERFACE(intrinsic_fbs::ImuStatus,
                                 intrinsic_fbs::BuildImuStatus,
                                 "intrinsic_fbs.ImuStatus");

INTRINSIC_ADD_HARDWARE_INTERFACE(::intrinsic_fbs::LaserTrackerState,
                                 intrinsic_fbs::BuildLaserTrackerState,
                                 "intrinsic_fbs.LaserTrackerState")


// LINT.ThenChange(//intrinsic_control/intrinsic/icon/server/auto_config_helpers.cc)
}  // namespace hardware_interface_traits
}  // namespace intrinsic::icon
