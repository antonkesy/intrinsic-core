...
// LINT.IfChange(MaxFaultReasonLength)
// The maximum length of a fault reason string. To be the same length as defined
// in the flatbuffer.
constexpr size_t kMaxFaultReasonLength = 256;
// LINT.ThenChange(//intrinsic_control/intrinsic/icon/hal/interfaces/hardware_module_state.fbs:MaxFaultReasonLength)
...
// LINT.ThenChange(//intrinsic_control/intrinsic/icon/utils/init_hwm.go)
