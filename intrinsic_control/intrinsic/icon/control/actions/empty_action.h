...
#ifndef INTRINSIC_ICON_CONTROL_ACTIONS_EMPTY_ACTION_H_
#define INTRINSIC_ICON_CONTROL_ACTIONS_EMPTY_ACTION_H_
...
// Does not sense or command any signals.
// Use-case: this action can serve as default action for parts which do not
// perform control.
class EmptyAction final : public RtclActionInterface {
 public:
  static absl::StatusOr<std::unique_ptr<EmptyAction>> Create(
...
#endif  // INTRINSIC_ICON_CONTROL_ACTIONS_EMPTY_ACTION_H_
