...
// This registers the factory for the HomingAction.
...
const auto kUnused =
    GetGlobalRtclActionFactoryRegistry().RegisterTyped<HomingInfo::FixedParams>(
        HomingInfo::kActionTypeName, &HomingAction::Create,
        GetHomingSignature());
