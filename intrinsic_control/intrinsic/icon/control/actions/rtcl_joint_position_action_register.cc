...
// This registers the factory for the JointPositionAction.
...
const auto kUnused =
    GetGlobalRtclActionFactoryRegistry()
        .RegisterTyped<PointToPointMoveInfo::FixedParams>(
            PointToPointMoveInfo::kActionTypeName, &JointPositionAction::Create,
            GetPointToPointMoveSignature());
