...
// Registers the factory for the HalRangefinderPart.
...
const auto kUnused =
    GetGlobalRealtimePartFromProtoFactoryRegistry()
        .RegisterTyped<intrinsic_proto::icon::HalRangefinderPartConfig>(
            HalRangefinderPart::kPartTypeName, &HalRangefinderPart::FromProto);
