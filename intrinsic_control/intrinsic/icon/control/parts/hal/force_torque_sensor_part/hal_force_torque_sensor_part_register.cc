...
// Registers the factory for the ForceTorqueSensorPart.
...
const auto kUnused =
    GetGlobalRealtimePartFromProtoFactoryRegistry()
        .RegisterTyped<intrinsic_proto::icon::HalForceTorqueSensorPartConfig>(
            HalForceTorqueSensorPart::kPartTypeName,
            &HalForceTorqueSensorPart::FromProto);
