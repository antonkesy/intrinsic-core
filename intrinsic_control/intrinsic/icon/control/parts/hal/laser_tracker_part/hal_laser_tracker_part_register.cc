...
// Registers the factory for the CartesianPositionPart.
...
const auto kUnused =
    GetGlobalRealtimePartFromProtoFactoryRegistry()
        .RegisterTyped<intrinsic_proto::icon::HalLaserTrackerPartConfig>(
            HalLaserTrackerPart::kPartTypeName,
            &HalLaserTrackerPart::FromProto);
