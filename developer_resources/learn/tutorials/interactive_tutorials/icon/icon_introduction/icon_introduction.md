...
>    [`name`](/incode/intrinsic_apis/intrinsic/icon/hal/proto/hardware_module_config.proto#L38)
...
ICON service using
[`ListActionSignatures()`](/incode/intrinsic_apis/intrinsic/icon/proto/v1/service.proto#L520), or `inctl icon list-actions --address=localhost:17080 --instance_name my_control_service`.
...
[`HardwareModuleState`](/incode/intrinsic_control/intrinsic/icon/hal/interfaces/hardware_module_state.fbs). Transitions
between states follow [this state
machine](/incode/intrinsic_control/intrinsic/icon/hal/hardware_module_interface.h#L62).

The ICON service manages the states of all hardware modules, and aggregates
those states into a simpler state model called
[`OperationalState`](/incode/intrinsic_apis/intrinsic/icon/proto/v1/types.proto#L352)
...
contains an
[`intrinsic_proto.icon.IconMainConfig`](/incode/intrinsic_apis/intrinsic/icon/server/config/icon_main_config.proto#L73)
...
service](/incode/intrinsic_control/intrinsic/icon/proto/v1/autogenerated_icon_config_service.proto)
...
Each part has a
[`RealtimePartConfig`](/incode/intrinsic_apis/intrinsic/icon/control/parts/proto/v1/realtime_part_config.proto#L31)
...
* `part_type_name`
  ...
  registry](/incode/intrinsic_control/intrinsic/icon/control/parts/hal/force_torque_sensor_part/hal_force_torque_sensor_part_register.cc).
...
> use the
> [`hardware_module_introspection`](/incode/intrinsic_control/intrinsic/icon/hal/tools/hardware_module_introspection.cc)
> tool to find the hardware interface names for any *running* HWM.

[This
folder](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal)
contains the configuration protos for all available parts. Here are some
examples for the three most commonly-used ones.

#### [`HalArmPart`](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal/arm_part/hal_arm_part.h)

[`intrinsic_proto.icon.HalArmPartConfig`](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal/arm_part/hal_arm_part_config.proto#L16C9-L16C25)
...
#### [`HalADIOPart`](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal/adio_part/hal_adio_part.h)

[`intrinsic_proto.icon.HalArmPartConfig`](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal/adio_part/hal_adio_part_config.proto#L16)
...
#### [`HalForceTorqueSensorPart`](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal/force_torque_sensor_part/hal_force_torque_sensor_part.h)

[`intrinsic_proto.icon.HalForceTorqueSensorPartConfig`](/incode/intrinsic_apis/intrinsic/icon/control/parts/hal/force_torque_sensor_part/hal_force_torque_sensor_part_config.proto#L11)
