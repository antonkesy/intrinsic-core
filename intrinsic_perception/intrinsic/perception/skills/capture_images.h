...
#ifndef INTRINSIC_PERCEPTION_SKILLS_CAPTURE_IMAGES_H_
#define INTRINSIC_PERCEPTION_SKILLS_CAPTURE_IMAGES_H_
...
class CaptureImages : public SkillInterface {
 public:
...
#endif  // INTRINSIC_PERCEPTION_SKILLS_CAPTURE_IMAGES_H_
