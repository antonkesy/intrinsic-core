...
#ifndef INTRINSIC_PERCEPTION_SKILLS_CALIBRATION_CALIBRATE_CAMERA_TO_ROBOT_H_
#define INTRINSIC_PERCEPTION_SKILLS_CALIBRATION_CALIBRATE_CAMERA_TO_ROBOT_H_
...
//
// Skill that performs a camera-to-robot calibration for a set of cameras.
class CalibrateCameraToRobot : public SkillInterface {
 public:
  ...
  ~CalibrateCameraToRobot() override = default;
};

}  // namespace skills
}  // namespace intrinsic

#endif  // INTRINSIC_PERCEPTION_SKILLS_CALIBRATION_CALIBRATE_CAMERA_TO_ROBOT_H_
