...
#ifndef INTRINSIC_PERCEPTION_SKILLS_CALIBRATION_CALIBRATE_INTRINSIC_H_
#define INTRINSIC_PERCEPTION_SKILLS_CALIBRATION_CALIBRATE_INTRINSIC_H_
...
// calibrate_intrinsic
//
// Skill that performs an intrinsic calibration for a set of cameras.
class CalibrateCameraIntrinsic : public SkillInterface {
 public:
  ...
  ~CalibrateCameraIntrinsic() override = default;
};

}  // namespace skills
}  // namespace intrinsic

#endif  // INTRINSIC_PERCEPTION_SKILLS_CALIBRATION_CALIBRATE_INTRINSIC_H_
