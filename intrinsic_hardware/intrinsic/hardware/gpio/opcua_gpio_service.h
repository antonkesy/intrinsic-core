...
#ifndef INTRINSIC_HARDWARE_GPIO_OPCUA_GPIO_SERVICE_H_
#define INTRINSIC_HARDWARE_GPIO_OPCUA_GPIO_SERVICE_H_
...
#endif  // INTRINSIC_HARDWARE_GPIO_OPCUA_GPIO_SERVICE_H_
