...
class SuctionGripperImpl
    : public intrinsic_proto::eoat::SuctionGripper::Service {
 public:
  explicit SuctionGripperImpl(
      std::shared_ptr<::intrinsic::gripper::GripperImpl<
          ::intrinsic_proto::eoat::SuctionGripperConfig>>
          gripper_impl)
      : gripper_impl_(std::move(gripper_impl)) {}

  ~SuctionGripperImpl() override = default;
  ...
  Status BlowOff(grpc::ServerContext* context,
                 const intrinsic_proto::eoat::BlowOffRequest* request,
                 intrinsic_proto::eoat::BlowOffResponse* response) override {
    return gripper_impl_->BlowOff(*request);
  }
...
std::unique_ptr<intrinsic_proto::eoat::SuctionGripper::Service>
MakeSuctionGripperService(std::shared_ptr<::intrinsic::gripper::GripperImpl<
                              ::intrinsic_proto::eoat::SuctionGripperConfig>>
                              gripper_impl) {
  return std::make_unique<SuctionGripperImpl>(gripper_impl);
}
