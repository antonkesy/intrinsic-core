...
#ifndef INTRINSIC_HARDWARE_GRIPPER_EOAT_GRIPPER_HEALTH_SERVICE_H_
#define INTRINSIC_HARDWARE_GRIPPER_EOAT_GRIPPER_HEALTH_SERVICE_H_
...
// Creates health service for suction gripper. The `GripperImpl` object is
// accepted as a shared pointer since it may be shared with other grpc services
// (e.g. SuctionGripper service).
...
// Creates health service for pinch gripper. The `GripperImpl` object is
// accepted as a shared pointer since it may be shared with other grpc services
// (e.g. PinchGripper service).
std::unique_ptr<intrinsic_proto::resources::ResourceHealth::Service>
MakeGripperHealthService(std::shared_ptr<::intrinsic::gripper::GripperImpl<
                             ::intrinsic_proto::eoat::PinchGripperConfig>>
                             gripper_impl);

// Creates ServiceState service for suction gripper. The `GripperImpl` object is
// accepted as a shared pointer since it may be shared with other grpc services
// (e.g. SuctionGripper service).
...
// Creates ServiceState service for pinch gripper. The `GripperImpl` object is
// accepted as a shared pointer since it may be shared with other grpc services
// (e.g. PinchGripper service).
std::unique_ptr<intrinsic_proto::services::v1::ServiceState::Service>
MakeGripperServiceState(std::shared_ptr<::intrinsic::gripper::GripperImpl<
...
#endif  // INTRINSIC_HARDWARE_GRIPPER_EOAT_GRIPPER_HEALTH_SERVICE_H_
