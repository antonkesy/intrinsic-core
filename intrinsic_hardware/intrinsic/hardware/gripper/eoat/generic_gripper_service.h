...
#ifndef INTRINSIC_HARDWARE_GRIPPER_EOAT_GENERIC_GRIPPER_SERVICE_H_
#define INTRINSIC_HARDWARE_GRIPPER_EOAT_GENERIC_GRIPPER_SERVICE_H_
...
// Creates a `GenericGripper` service for pinch gripper. The shared pointer to
// `GripperImpl` object is required since it may be shared among different GRPC
// services.
...
// Creates a `GenericGripper` service for suction gripper. The shared pointer to
// `GripperImpl` object is required since it may be shared among different GRPC
// services.
std::unique_ptr<intrinsic_proto::gripper::GenericGripper::Service>
MakeGenericGripperService(std::shared_ptr<::intrinsic::gripper::GripperImpl<
...
#endif  // INTRINSIC_HARDWARE_GRIPPER_EOAT_GENERIC_GRIPPER_SERVICE_H_
