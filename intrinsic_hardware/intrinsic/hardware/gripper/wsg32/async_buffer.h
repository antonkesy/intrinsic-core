...
#ifndef INTRINSIC_RTT_HWMS_WSG32_ASYNC_BUFFER_H_
#define INTRINSIC_RTT_HWMS_WSG32_ASYNC_BUFFER_H_

#include <atomic>
#include <cstdint>
#include <memory>

namespace intrinsic::wsg32 {
...
#endif  // INTRINSIC_RTT_HWMS_WSG32_ASYNC_BUFFER_H_
