...
- **Model Macro**: `fanuc_lrmate_description/urdf/lrmate200id4s_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_lrmate_description/meshes/lrmate200id4s/visual/` (`.dae`)
...
The `lr_mate_200id_4s_base.xacro` file is derived from the upstream URDF file (`fanuc_lrmate_description/urdf/lrmate200id4s_urdf_macro.xacro`).
