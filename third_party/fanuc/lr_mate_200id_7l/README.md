...
- **Model Macro**: `fanuc_lrmate_description/urdf/lrmate200id7l_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_lrmate_description/meshes/lrmate200id7l/visual/` (`.dae`)
...
The `lr_mate_200id_7l_base.xacro` file is derived from the upstream URDF file (`fanuc_lrmate_description/urdf/lrmate200id7l_urdf_macro.xacro`).
