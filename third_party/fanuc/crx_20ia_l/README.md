...
- **Model Macro**: `fanuc_crx_description/urdf/crx20ia_l_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_crx_description/meshes/crx20ia_l/visual/` (`.dae`)
...
The `crx_20ia_l_base.xacro` file is derived from the upstream URDF file (`fanuc_crx_description/urdf/crx20ia_l_urdf_macro.xacro`).
