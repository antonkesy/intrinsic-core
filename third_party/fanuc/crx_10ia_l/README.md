...
- **Model Macro**: `fanuc_crx_description/urdf/crx10ia_l_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_crx_description/meshes/crx10ia_l/visual/` (`.dae`)
...
The `crx_10ia_l_base.xacro` file is derived from the upstream URDF file (`fanuc_crx_description/urdf/crx10ia_l_urdf_macro.xacro`).
