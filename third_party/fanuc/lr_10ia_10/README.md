...
- **Model Macro**: `fanuc_lrmate_description/urdf/lrmate10_11a_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_lrmate_description/meshes/lrmate10_11a/visual/` (`.dae`)
...
The `lr_10ia_10_base.xacro` file is derived from the upstream URDF file (`fanuc_lrmate_description/urdf/lrmate10_11a_urdf_macro.xacro`).
