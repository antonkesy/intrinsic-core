...
- **Model Macro**: `fanuc_crx_description/urdf/crx30ia_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_crx_description/meshes/crx30ia/visual/` (`.dae`)
...
The `crx_30ia_base.xacro` file is derived from the upstream URDF file (`fanuc_crx_description/urdf/crx30ia_urdf_macro.xacro`).
