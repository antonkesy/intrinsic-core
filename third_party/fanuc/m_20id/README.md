...
- **Model Macro**: `fanuc_m20_description/urdf/m20_25_18d_urdf_macro.xacro`
- **Visual Meshes**: `fanuc_m20_description/meshes/m20_25_18d/visual/` (`.dae`)
...
The `m_20id_base.xacro` file is derived from the upstream URDF file (`fanuc_m20_description/urdf/m20_25_18d_urdf_macro.xacro`).
