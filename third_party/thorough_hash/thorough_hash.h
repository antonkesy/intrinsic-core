...
// Forked from:
// https://github.com/google/or-tools/blob/v9.4/ortools/base/thorough_hash.h
// Changes:
// - Drops integral_types header (not needed).
// - Changes namespace to instrinsic
// - Prefixes header include guard with `THIRD_PARTY`.

#ifndef THIRD_PARTY_THOROUGH_HASH_THOROUGH_HASH_H_
#define THIRD_PARTY_THOROUGH_HASH_THOROUGH_HASH_H_
...
#endif  // THIRD_PARTY_THOROUGH_HASH_THOROUGH_HASH_H_
