...
#ifndef INTRINSIC_KINEMATICS_IK_RT_CALIBRATED_UR_INVERSE_KINEMATICS_H_
#define INTRINSIC_KINEMATICS_IK_RT_CALIBRATED_UR_INVERSE_KINEMATICS_H_
...
enum class UrRobotType { Ur3e, Ur5e, Ur10e, Ur16e, Ur20 };
...
class RtCalibratedUrInverseKinematics final
    : public InverseKinematicsInterfaceRT {
 public:
  using InverseKinematicsInterface::ComputeIK;

  static constexpr char kSolverName[] = "calibrated_ur";

  static absl::StatusOr<std::unique_ptr<RtCalibratedUrInverseKinematics>>
  Create(Chain chain, const UrRobotType& arm_type,
 ...
 private:
  explicit RtCalibratedUrInverseKinematics(Chain chain)
  ...
  const absl::flat_hash_map<UrRobotType, std::string>
      arm_type_to_skeleton_proto_ = {
          ...
          {UrRobotType::Ur20,
           "intrinsic_kinematics/intrinsic/kinematics/"
           "ur_proto_skeletons/ur20.pbtxt"}};
};

}  // namespace kinematics
}  // namespace intrinsic

#endif  // INTRINSIC_KINEMATICS_IK_RT_CALIBRATED_UR_INVERSE_KINEMATICS_H_
