...
#ifndef INTRINSIC_WORLD_SKILLS_CREATE_OBJECT_CREATE_OBJECT_H_
#define INTRINSIC_WORLD_SKILLS_CREATE_OBJECT_CREATE_OBJECT_H_
...
class CreateObject : public SkillInterface {
 public:
...
#endif  // INTRINSIC_WORLD_SKILLS_CREATE_OBJECT_CREATE_OBJECT_H_
